...
IMGSZ = 640
BATCH = 2
EPOCHS = 1  # 可先跑 5~10 看收斂

base_lr = 3e-3
end_lr = 1e-5
momentum = 0.9

USE_AMP = False  # 設定為 True 以啟用混合精度訓練 (建議在 NVIDIA V100, T4, A100, 30xx, 40xx 系列 GPU 上開啟)

# REP_DIR = "../dataset/lanepose/mix_QAT/images/*.jpg"  # 代表集資料夾（放 500~1000 張）
REP_DIR = "../dataset/lanepose/test1/images/*.jpg"  # 代表集資料夾（放 500~1000 張）
