...
def get_flops(model, imgsz=640):
    ...
    try:
        ...
        # thop profiling can segfault with custom deformable conv implementations on some torch/torchvision builds.
        # Skip FLOPs computation for these models to keep training stable.
        if any(m.__class__.__name__ == "ConformableConv2d" for m in model.modules()):
            return 0.0
